...
from ddpg_meta_ablation import ddpg_adapt
...
def copy_ddpg_to_ppo(ddpg_actor, ppo_actor):
...
def train_multi_env(env_list, model, optimizer, device):
    ...
    for update in range(1, num_updates + 1):
        ...
        print(">> Directly replace PPO with DDPG")
...
if __name__ == "__main__":
    set_seed(SEED)
    print("=" * 60)
    print(f"Running ablation experiment with seed = {SEED}")
    print("=" * 60)
