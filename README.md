Overview: This branch adds a PI control loop and a fixed supervisory mode to check that the PI loop works as expected in the simplified building environment.
